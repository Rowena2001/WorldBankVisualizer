...
/**
 * Class MainUI initiates a Jframe window, receives user input/choices, and renders graphs
 * @author Group 15
 *
 */
...
public class MainUI extends JFrame {
	...
	/**
	 * Constructor that creates JFrame window, receives user input/choices, and renders graphs
	 */
	private MainUI() {
		// Set window title
		...
		/**
		 * Recalculate generates analysis when recalculate button is pressed
		 */
		...
		/*
		 * viewsList populates compatible views, sets viewer in selection object
		 */
		...
		/**
		 * addView adds a viewer that corresponds to user selections when add viewer button is pressed
		 */
		...
		/**
		 * removwView removes the correct viewer when remove viewer button is pressed
		 */
	...
	/**
	 * Invoked by addView
	 * Renders and resizes graph to put on west panel
	 * @param v
	 * @param rows
	 * @param columns
	 */
